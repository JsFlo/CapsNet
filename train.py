...
def get_reconstruction_loss(mask_with_labels, correct_labels_placeholder, single_digit_prediction, digitCaps_postRouting, input_image_batch):
    ...
    reconstruction_targets = tf.cond(mask_with_labels,  # condition
                                     lambda: correct_labels_placeholder,  # if True
                                     lambda: single_digit_prediction)  # if False)
